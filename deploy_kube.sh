...
LOCAL_IMAGE="numerical"
TAG="latest"
NAMESPACE="default"
SECRET_NAME="numerical-secret"
ENV_FILE=".env"
...
function set_default_variables {
    IMAGE_NAME="numerical"
    KUBE_DEPLOYMENT="numerical-app"
    DEPLOYMENT_FILE="deployment.yaml"
}

# Function to set mac specific variables
function set_mac_variables {
    IMAGE_NAME="numerical_mac"
    KUBE_DEPLOYMENT="numerical-app-mac"
